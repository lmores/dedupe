...
_dedupe_clusters = '_csv_example_output.csv'

true_dupes = dupePairs(manual_clusters, 'True Id')
test_dupes = dupePairs(dedupe_clusters, 'Cluster ID')
_test_dupes = dupePairs(_dedupe_clusters, 'Cluster ID')

print("Official dedupe library:")
evaluateDuplicates(test_dupes, true_dupes)

print("\nModified dedupe library:")
evaluateDuplicates(_test_dupes, true_dupes)
