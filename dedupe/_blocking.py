...
if TYPE_CHECKING:
    ...
    from dedupe.__typing import Data, Record, RecordID
...
class Fingerprinter(object):
    ...
    def __init__(self, predicates: Iterable[dedupe._predicates.Predicate]) -> None:

        self.predicates = predicates

        self.index_fields: dict[int, IndexList]
        ...
        for full_predicate in predicates:
            for predicate in full_predicate:
                if hasattr(predicate, "index"):
                    self.index_fields[predicate.field_index][predicate.type].append(predicate)
    ...
    def index(self, docs: Docs, field: int) -> None:
        """
    ...
    def unindex(self, docs: Docs, field: int) -> None:
    ...
    def index_all(self, data: Data) -> None:
        for field in self.index_fields:
            unique_fields = {record[field] for record in data if record[field]}
