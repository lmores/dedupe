...
from dedupe import _predicates as predicates
from dedupe.__typing import VariableDefinition
from dedupe.variables._base import FieldType, indexPredicates
